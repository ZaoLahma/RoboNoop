...
from ..hw_interface.comm.hw_if_messages import ALL_COMMAND_MESSAGES
...
class Main:
    ...
    def run():
        ...
        protocol = MessageProtocol(ALL_CORE_MESSAGES + ALL_IMAGE_CONTROL_MESSAGES + ALL_VISION_MESSAGES + ALL_COMMAND_MESSAGES)
