...
class Window(Tk):
    def __init__(self, resolution):
        ...
        self.ws_controller = WorkspaceController(self.ws_frame, self.ws_resolution)
    ...
    def add_workspace(self, WS_CLASS):
        self.ws_controller.add_workspace(WS_CLASS)
        ws_button = ttk.Button(self.btn_frame, text = WS_CLASS.get_id(), command = lambda : self.activate_workspace(WS_CLASS))
